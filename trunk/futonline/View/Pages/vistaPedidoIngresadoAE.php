...
?>
<body style="background-color:#0A8A9A; font: Helvetica 12pt;"> <span style="color:white;"><b><font size="6pt"> Listado de pedidos Ingresados.</font></b></span> <br><br>
    <div> <b> <a href ="../../Controller/controladorPedidoIngresadoAE.php" style="color: white;">Ingresados</a></b>
        <a href ="../../Controller/controladorPedidoDespachadoAE.php" style="color: white;" > Despachados</a>
        ...
        <form name="cancelar" id="cancelar" action="../../Controller/controladorCancelarPedido.php" method="POST">
            <table BGCOLOR ="#FFFFFF" border="1">
                <tr>
                    ...
                    <?php if($_SESSION['nivelPermiso']==3){?>
                ...
                foreach ($pedidos as $pedido) {
                    ...
                    <tr>
                        ...
                        <td><div align="center"><a href="../../Controller/controladorDetalle.php?id=<?php echo $pedido['COD_PED'] ?>">Mostrar </a>
                            </div></td>
                            <?php if($_SESSION['nivelPermiso']==3){?>
