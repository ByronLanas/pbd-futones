...
?>
<body style="background-color:#0A8A9A; font: Helvetica 12pt;"> <span style="color:white;"><b><font size ="6pt"> Listado de pedidos Cancelados.</font> </b></span> <br><br>
    <div> <a href ="../../Controller/controladorPedidoIngresadoAE.php" style="color: white;">Ingresados</a>
        ...
        <b><a href ="../../Controller/controladorPedidoCanceladoAE.php" style="color: white;"> Cancelados</a></b>
    </div>    
    <br>
    <?php
    if (isset($pedidos)) {
    ...
    <?php } else { ?> <table border ="1" style="color: white">
            <tr><td>No hay pedidos cancelados para mostrar</td></tr></table>
