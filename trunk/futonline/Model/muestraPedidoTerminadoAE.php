...
class muestraPedidoTerminadoAE{
    
    var $link;
    public function muestraPedidoTerminadoAE(){
    ...
    public function consultar_pedidoTerminadoAE(){        
        $sql = "SELECT CLI_NOM,c.CLI_RUT, CONVERT(char(8),FEC_PED,103) as FEC_PED,EST_PED
      ,MONT_PED,TIEM_PED,COD_PED FROM pedido as p,cliente as c WHERE p.cli_rut=c.cli_rut and est_ped = 'terminado' ORDER BY fec_ped";
