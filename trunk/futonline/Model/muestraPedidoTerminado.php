...
class muestraPedidoTerminado{
    
    var $link;
    public function muestraPedidoTerminado(){
    ...
    public function consultar_pedidoTerminado($usuario){        
      ...
      ,MONT_PED,TIEM_PED,COD_PED FROM pedido WHERE cli_rut='$usuario' and est_ped = 'terminado' ORDER BY fec_ped";
        $result= odbc_exec($this->link,$sql)or die(exit("Error en odbc_exec"));
