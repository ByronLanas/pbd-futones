...
class muestraPedidoIngresadoAE{
    
    var $link;
    public function muestraPedidoIngresadoAE(){
    ...
    public function consultar_pedidoIngresadoAE(){        
        $sql = "SELECT CLI_NOM,c.CLI_RUT, CONVERT(char(8),FEC_PED,3) as FEC_PED,EST_PED
      ,MONT_PED,TIEM_PED,COD_PED FROM pedido as p,cliente as c WHERE c.cli_rut=p.cli_rut and p.est_ped = 'ingresado' ORDER BY fec_ped";
