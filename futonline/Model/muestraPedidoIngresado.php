...
class muestraPedidoIngresado{
    
    var $link;
    public function muestraPedidoIngresado(){
    ...
    public function consultar_pedidoIngresado($usuario){        
        ...
        $sql = "SELECT CLI_RUT, CONVERT(char(8),FEC_PED,3) as FEC_PED,EST_PED
      ,MONT_PED,TIEM_PED,COD_PED FROM pedido WHERE cli_rut='$usuario' and est_ped = 'ingresado' ORDER BY fec_ped";
        $result= odbc_exec($this->link,$sql)or die(exit("Error en odbc_exec"));
