...
class muestraPedidoDespachado{
    
    var $link;
    public function muestraPedidoDespachado(){
    ...
    public function consultar_pedidoDespachado($usuario){        
      ...
      ,MONT_PED,TIEM_PED,COD_PED FROM pedido WHERE cli_rut='$usuario' and est_ped = 'despachado' ORDER BY fec_ped";
        $result= odbc_exec($this->link,$sql)or die(exit("Error en odbc_exec"));
